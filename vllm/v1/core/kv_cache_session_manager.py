...
class KvCacheSessionManager:
    """
    Manages session-level reference counting for KV cache blocks.
    Tracks which sessions reference which blocks, enabling shared
    KV cache across sessions with proper lifecycle management.
    """
